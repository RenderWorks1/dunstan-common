...
export default function HomesSummary() {
  return (
    <section id="homes" className="bg-amazon-100 overflow-hidden pt-24 md:pt-32 lg:pt-40 pb-32 md:pb-44 lg:pb-48">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            ...
            <AnimateOnScroll delay={0.16}>
              <h2 className="font-hero-tagline font-normal leading-[1.15] text-dark-text text-2xl sm:text-3xl md:text-4xl mb-16 md:mb-20 lg:text-[2.75rem]">
